    ...
    <div className='container'>
      <div className='searchAgent-box'>
        ...
        <div className='roles-box animate__animated  animate__backInLeft'  >
          <button className='b-roles' style={{background: colors.button}} onClick={() => { setRol("Duelista") }}>
          ...
          <button className='b-roles' style={{background: colors.button}} onClick={() => { setRol("Iniciador") }}>
          ...
          <button className='b-roles' style={{background: colors.button}} onClick={() => { setRol("Centinela") }}>
          ...
          <button className='b-roles' style={{background: colors.button}} onClick={() => { setRol("Controlador") }}>
          ...
          <button className='b-roles' style={{background: colors.button}} onClick={() => { setRol("") }}>
            <span>TODOS</span>{}
          </button>
        </div>

        <form className='animate__animated  animate__backInRight' action="">
          <input className='search-agent' type="text" placeholder="Buscar..." style={{background: colors.button, color: colors.textInput}} />
        </form>
      </div>
      <h1>{rol}</h1>
